...
export const ACHIEVEMENTS = [
  ...
  { id: 'sheep50',  name: 'Houfek',            desc: '50 ovcí',                 test: s => s.world.maxSheep >= 50 },
  { id: 'sheep100', name: 'Stádo',             desc: '100 ovcí',                test: s => s.world.maxSheep >= 100, bonus: 0.02 },
  { id: 'sheep500', name: 'Početné stádo',     desc: '500 ovcí',                test: s => s.world.maxSheep >= 500 },
  { id: 'sheep1k',  name: 'Houf',              desc: '1 000 ovcí',              test: s => s.world.maxSheep >= 1e3, bonus: 0.03 },
  { id: 'sheep10k', name: 'Desetitisícové stádo', desc: '10 000 ovcí',         test: s => s.world.maxSheep >= 1e4 },
  { id: 'sheep100k',name: 'Statisícové stádo', desc: '100 000 ovcí',           test: s => s.world.maxSheep >= 1e5 },
  ...
  { id: 'cred10k',  name: 'Desetitisícovka',   desc: '10 000 kreditů',          test: s => s.world.maxCredits >= 1e4 },
  { id: 'cred100k', name: 'Sto tisíc',         desc: '100 000 kreditů',         test: s => s.world.maxCredits >= 1e5 },
  { id: 'cred1m',   name: 'Milionář',          desc: '1 milion kreditů',        test: s => s.world.maxCredits >= 1e6, bonus: 0.02 },
  { id: 'cred10m',  name: 'Desetimilionář',    desc: '10 milionů kreditů',      test: s => s.world.maxCredits >= 1e7 },
  { id: 'cred100m', name: 'Stomilionář',       desc: '100 milionů kreditů',     test: s => s.world.maxCredits >= 1e8 },
