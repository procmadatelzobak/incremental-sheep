...
//  nákup čehokoli vyprázdní sklad (pravidlo lore §9).
// ===========================================================================
...
// Strop skladu pro každou surovinu zvlášť: úroveň skladu × přírůstek (#38).
...
export function applyProduced(state, produced, mults) {
  if (storageEnabled(state)) clampStorage(state);   // případné zmenšení stropu ořízne přebytek (#38)
